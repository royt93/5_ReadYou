...
## Vấn đề thực tế
Những người thích đọc tin tức thường muốn theo dõi tiến độ đọc, số bài đọc mỗi tuần, chủ đề đọc nhiều nhất và chuỗi ngày đọc liên tục (reading streak). Hiện tại app chưa có màn hình thống kê nào tổng hợp dữ liệu đọc từ Room.
...
```
Bạn đang thực hiện task [IDEA-01] "Bảng Thống Kê Thói Quen Đọc Sách & Biểu Đồ Hoạt Động (Reading Habits & Heatmap)" trong repo RSS Cat Hub (com.mckimquyen.reader, xem CLAUDE.md để hiểu kiến trúc). Đọc kỹ "Vấn đề thực tế" + "Acceptance Criteria" trong file doc/task/todo/IDEA-01_reading-habits-heatmap.md trước khi bắt đầu.
...
3. Với thay đổi kiến trúc/thiết kế quan trọng (không bắt buộc cho fix nhỏ, 1-2 dòng), tham khảo ý kiến độc lập từ 2 AI agent khác trước khi chốt:
   - `codex exec -s workspace-write "Review approach cho task [IDEA-01] trong repo RSS Cat Hub: <tóm tắt ngắn cách bạn định làm>. Chỉ ra rủi ro/cách tốt hơn nếu có."`
   - `claude -p "Review approach cho task [IDEA-01] trong repo RSS Cat Hub: <tóm tắt ngắn cách bạn định làm>. Chỉ ra rủi ro/cách tốt hơn nếu có." --allowedTools "Read Grep Glob"`
