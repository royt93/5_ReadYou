...
sealed class FlowArticleListTonalElevationPref(val value: Int) : Pref() {
    object Level0 : FlowArticleListTonalElevationPref(ElevationTokens.Level0)
    object Level1 : FlowArticleListTonalElevationPref(ElevationTokens.Level1)
    object Level2 : FlowArticleListTonalElevationPref(ElevationTokens.Level2)
    object Level3 : FlowArticleListTonalElevationPref(ElevationTokens.Level3)
    object Level4 : FlowArticleListTonalElevationPref(ElevationTokens.Level4)
    object Level5 : FlowArticleListTonalElevationPref(ElevationTokens.Level5)
