...
sealed class FeedsGroupListTonalElevationPref(val value: Int) : Pref() {
    object Level0 : FeedsGroupListTonalElevationPref(ElevationTokens.Level0)
    object Level1 : FeedsGroupListTonalElevationPref(ElevationTokens.Level1)
    object Level2 : FeedsGroupListTonalElevationPref(ElevationTokens.Level2)
    object Level3 : FeedsGroupListTonalElevationPref(ElevationTokens.Level3)
    object Level4 : FeedsGroupListTonalElevationPref(ElevationTokens.Level4)
    object Level5 : FeedsGroupListTonalElevationPref(ElevationTokens.Level5)
