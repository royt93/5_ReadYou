...
sealed class ReadingPageTonalElevationPref(val value: Int) : Pref() {
    object Level0 : ReadingPageTonalElevationPref(ElevationTokens.Level0)
    object Level1 : ReadingPageTonalElevationPref(ElevationTokens.Level1)
    object Level2 : ReadingPageTonalElevationPref(ElevationTokens.Level2)
    object Level3 : ReadingPageTonalElevationPref(ElevationTokens.Level3)
    object Level4 : ReadingPageTonalElevationPref(ElevationTokens.Level4)
    object Level5 : ReadingPageTonalElevationPref(ElevationTokens.Level5)
