...
sealed class FeedsTopBarTonalElevationPref(val value: Int) : Pref() {
    object Level0 : FeedsTopBarTonalElevationPref(ElevationTokens.Level0)
    object Level1 : FeedsTopBarTonalElevationPref(ElevationTokens.Level1)
    object Level2 : FeedsTopBarTonalElevationPref(ElevationTokens.Level2)
    object Level3 : FeedsTopBarTonalElevationPref(ElevationTokens.Level3)
    object Level4 : FeedsTopBarTonalElevationPref(ElevationTokens.Level4)
    object Level5 : FeedsTopBarTonalElevationPref(ElevationTokens.Level5)
