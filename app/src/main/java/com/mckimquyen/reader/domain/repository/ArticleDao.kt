...
import com.mckimquyen.reader.domain.model.feed.ImportantNum
import java.util.*
...
interface ArticleDao {
    ...
    @Query(
        ...
        a.accountId, a.isUnread, a.isStarred, a.isReadLater, a.updateAt, a.aiSummary 
        FROM article AS a
    ...
    @Query(
        """
        SELECT * FROM article
        WHERE accountId = :accountId AND isUnread = 1
        ORDER BY date DESC
        LIMIT :limit
        """
    )
